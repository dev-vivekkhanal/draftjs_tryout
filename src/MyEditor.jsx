...
// ############## MAIN ONE ##################### just after enter new formmatting are not reviving #######
...
//     ) {
//       const updatedStart = selection.getStartOffset() - 2;
//       const updatedSelection = selection.merge({ anchorOffset: updatedStart });
//       const replacedContent = Modifier.replaceText(
//         contentState,
//         updatedSelection,
//         " "
